...
const mockListeners: { conn: ((c: boolean) => void)[], tele: ((d: any) => void)[] } = { conn: [], tele: [] }
...
vi.mock('../../services/BluetoothService', () => {
  return {
    BluetoothService: class {
      ...
      addTelemetryListener(l: (d: any)=>void) { mockListeners.tele.push(l) }
      removeTelemetryListener(l: (d: any)=>void) { const i = mockListeners.tele.indexOf(l); if (i>-1) mockListeners.tele.splice(i,1) }
    }
  }
})
